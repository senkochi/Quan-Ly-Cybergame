...
public class ThemPhienChoiDialog extends javax.swing.JDialog {
    private MayTinhTable table;
    
    public void setTable(MayTinhTable table){
        this.table = table;
    }
    
    public ThemPhienChoiDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemPhienChoiDialog dialog = new ThemPhienChoiDialog(new javax.swing.JFrame(), true);
